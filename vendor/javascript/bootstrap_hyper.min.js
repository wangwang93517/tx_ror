...
!function (o) {
    ...
    e(), n = ".card", o(document).on("click", '.card a[data-bs-toggle="remove"]', function (e) {
        ...
        var n = o.extend({}, i, o(t).data()), a = n.targetDisplay;
        ...
        var n = o.extend({}, c, o(t).data());
        o(t).timepicker(n)
    })), jQuery().TouchSpin && (c = {}, o('[data-toggle="touchspin"]').each(function (e, t) {
        var n = o.extend({}, c, o(t).data());
        o(t).TouchSpin(n)
    })), jQuery().maxlength && (c = {
...
var ThemeCustomizer = function () {
    ...
    return _createClass(e, [{
        ...
        key: "setSwitchFromConfig", value: function () {
            sessionStorage.setItem("__HYPER_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".right-bar input[type=checkbox]").forEach(function (e) {
                e.checked = !1
            });
            var e, t, n, a, o, r, i, c, s = this.config;
            s && (e = document.querySelector("input[type=radio][name=data-layout][value=" + s.nav + "]"), t = document.querySelector("input[type=radio][name=data-theme][value=" + s.theme + "]"), n = document.querySelector("input[type=radio][name=data-layout-mode][value=" + s.layout.mode + "]"), a = document.querySelector("input[type=radio][name=data-topbar-color][value=" + s.topbar.color + "]"), o = document.querySelector("input[type=radio][name=data-menu-color][value=" + s.menu.color + "]"), r = document.querySelector("input[type=radio][name=data-sidenav-size][value=" + s.sidenav.size + "]"), i = document.querySelector("input[type=radio][name=data-layout-position][value=" + s.layout.position + "]"), c = document.querySelector("input[type=checkbox][name=sidebar-user]"), e && (e.checked = !0), t && (t.checked = !0), n && (n.checked = !0), a && (a.checked = !0), o && (o.checked = !0), r && (r.checked = !0), i && (i.checked = !0), c && "true" === s.sidenav.user.toString() && (c.checked = !0))
        }
    }, {
